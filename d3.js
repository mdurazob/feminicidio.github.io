...
var Domingo = weekday(0);
var Lunes = weekday(1);
var Martes = weekday(2);
var Miércoles = weekday(3);
var Jueves = weekday(4);
var Viernes = weekday(5);
var saturday = weekday(6);

var Domingos = Domingo.range;
var Luness = Lunes.range;
var Martess = Martes.range;
var Miércoless = Miércoles.range;
var Juevess = Jueves.range;
var Vierness = Viernes.range;
...
var utcDomingo = utcWeekday(0);
var utcLunes = utcWeekday(1);
var utcMartes = utcWeekday(2);
var utcMiércoles = utcWeekday(3);
var utcJueves = utcWeekday(4);
var utcViernes = utcWeekday(5);
var utcSaturday = utcWeekday(6);

var utcDomingos = utcDomingo.range;
var utcLuness = utcLunes.range;
var utcMartess = utcMartes.range;
var utcMiércoless = utcMiércoles.range;
var utcJuevess = utcJueves.range;
var utcVierness = utcViernes.range;
...
function formatLocale$1(locale) {
  ...
  var formats = {
    ...
    "S": formatSeconds,
    "u": formatWeekdayNumberLunes,
    "U": formatWeekNumberDomingo,
    "V": formatWeekNumberISO,
    "w": formatWeekdayNumberDomingo,
    "W": formatWeekNumberLunes,
    "x": null,
    "X": null,
    "y": formatYear$1,
    "Y": formatFullYear,
  ...
  var utcFormats = {
    ...
    "s": formatUnixTimestampSeconds,
    "S": formatUTCSeconds,
    "u": formatUTCWeekdayNumberLunes,
    "U": formatUTCWeekNumberDomingo,
    "V": formatUTCWeekNumberISO,
    "w": formatUTCWeekdayNumberDomingo,
    "W": formatUTCWeekNumberLunes,
    "x": null,
    "X": null,
    "y": formatUTCYear,
    "Y": formatUTCFullYear,
  ...
  var parses = {
    ...
    "S": parseSeconds,
    "u": parseWeekdayNumberLunes,
    "U": parseWeekNumberDomingo,
    "V": parseWeekNumberISO,
    "w": parseWeekdayNumberDomingo,
    "W": parseWeekNumberLunes,
    "x": parseLocaleDate,
    "X": parseLocaleTime,
    "y": parseYear,
    "Y": parseFullYear,
    ...
    return function(string) {
      ...
      if ("V" in d) {
        ...
        if ("Z" in d) {
          ...
          week = day$1 > 4 || day$1 === 0 ? utcLunes.ceil(week) : utcLunes(week);
          ...
          week = day$1 > 4 || day$1 === 0 ? Lunes.ceil(week) : Lunes(week);
...
function parseWeekdayNumberDomingo(d, string, i) {
  var n = numberRe.exec(string.slice(i, i + 1));
  return n ? (d.w = +n[0], i + n[0].length) : -1;
}

function parseWeekdayNumberLunes(d, string, i) {
  var n = numberRe.exec(string.slice(i, i + 1));
  return n ? (d.u = +n[0], i + n[0].length) : -1;
}

function parseWeekNumberDomingo(d, string, i) {
...
function parseWeekNumberLunes(d, string, i) {
  var n = numberRe.exec(string.slice(i, i + 2));
  return n ? (d.W = +n[0], i + n[0].length) : -1;
}
...
function formatWeekdayNumberLunes(d) {
  var day = d.getDay();
  return day === 0 ? 7 : day;
}

function formatWeekNumberDomingo(d, p) {
  return pad$1(Domingo.count(year(d) - 1, d), p, 2);
}

function formatWeekNumberISO(d, p) {
  var day = d.getDay();
  d = (day >= 4 || day === 0) ? Jueves(d) : Jueves.ceil(d);
  return pad$1(Jueves.count(year(d), d) + (year(d).getDay() === 4), p, 2);
}

function formatWeekdayNumberDomingo(d) {
  return d.getDay();
}

function formatWeekNumberLunes(d, p) {
  return pad$1(Lunes.count(year(d) - 1, d), p, 2);
}
...
function formatUTCWeekdayNumberLunes(d) {
  var dow = d.getUTCDay();
  return dow === 0 ? 7 : dow;
}

function formatUTCWeekNumberDomingo(d, p) {
  return pad$1(utcDomingo.count(utcYear(d) - 1, d), p, 2);
}

function formatUTCWeekNumberISO(d, p) {
  var day = d.getUTCDay();
  d = (day >= 4 || day === 0) ? utcJueves(d) : utcJueves.ceil(d);
  return pad$1(utcJueves.count(utcYear(d), d) + (utcYear(d).getUTCDay() === 4), p, 2);
}

function formatUTCWeekdayNumberDomingo(d) {
  return d.getUTCDay();
}

function formatUTCWeekNumberLunes(d, p) {
  return pad$1(utcLunes.count(utcYear(d) - 1, d), p, 2);
}
...
defaultLocale$1({
  ...
  months: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "June", "July", "August", "September", "October", "November", "December"],
...
function time() {
  return initRange.apply(calendar(year, month, Domingo, day, hour, minute, second, millisecond, exports.timeFormat).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]), arguments);
}

function utcTime() {
  return initRange.apply(calendar(utcYear, utcMonth, utcDomingo, utcDay, utcHour, utcMinute, second, millisecond, exports.utcFormat).domain([Date.UTC(2000, 0, 1), Date.UTC(2000, 0, 2)]), arguments);
}
...
exports.timeViernes = Viernes;
exports.timeVierness = Vierness;
...
exports.timeLunes = Lunes;
exports.timeLuness = Luness;
...
exports.timeDomingo = Domingo;
exports.timeDomingos = Domingos;
exports.timeJueves = Jueves;
exports.timeJuevess = Juevess;
exports.timeMartes = Martes;
exports.timeMartess = Martess;
exports.timeMiércoles = Miércoles;
exports.timeMiércoless = Miércoless;
exports.timeWeek = Domingo;
exports.timeWeeks = Domingos;
...
exports.utcViernes = utcViernes;
exports.utcVierness = utcVierness;
...
exports.utcLunes = utcLunes;
exports.utcLuness = utcLuness;
...
exports.utcDomingo = utcDomingo;
exports.utcDomingos = utcDomingos;
exports.utcJueves = utcJueves;
exports.utcJuevess = utcJuevess;
exports.utcMartes = utcMartes;
exports.utcMartess = utcMartess;
exports.utcMiércoles = utcMiércoles;
exports.utcMiércoless = utcMiércoless;
exports.utcWeek = utcDomingo;
exports.utcWeeks = utcDomingos;
